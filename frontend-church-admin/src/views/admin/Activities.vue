        ...
        <div v-else class="info-table">
          ...
          <div class="pagination">
            ...
            <div class="pagination-right">
              <button class="btn-secondary" @click="() => { currentPage--; loadActivities(); }" :disabled="currentPage === 1">
              ...
              <button class="btn-secondary" @click="() => { currentPage++; loadActivities(); }" :disabled="currentPage === totalPages">
                下一頁
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  try {
    ...
    if (response.ok) {
      ...
      if (data.success && data.data) {
        activitiesList.value = data.data || data.content || []
        // 更新分頁信息
