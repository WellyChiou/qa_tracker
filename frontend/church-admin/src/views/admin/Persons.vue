  ...
  <AdminLayout>
    <div class="admin-persons">
      ...
      <section class="overview-strip">
        ...
        <article class="overview-card">
          <span>查詢狀態</span>
          <strong>{{ filters.personName || filters.email || filters.phone ? '已套用' : '全部' }}</strong>
          <p>可透過姓名、Email 與電話快速縮小搜尋範圍。</p>
        </article>
      </section>
      ...
      <div class="persons-list card surface-card">
