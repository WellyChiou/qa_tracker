...
public class ChurchJwtUtil {
    ...
    public String generateAccessToken(String username, String system) {
        ...
        if (!"church".equals(system)) {
            throw new IllegalArgumentException("ChurchJwtUtil 只支援 church system token");
        }

        return createToken(claims, username, getChurchAccessTokenExpiration());
    }
    ...
    public String generateRefreshToken(String username, String system) {
        ...
        Boolean enabled = isChurchRefreshTokenEnabled();
        if (!enabled) {
        ...
        return createToken(claims, username, getChurchRefreshTokenExpiration());
    }
    ...
    private String createToken(Map<String, Object> claims, String subject, Long expiration) {
        ...
        return Jwts.builder()
                ...
                .signWith(getChurchSigningKey(), SignatureAlgorithm.HS256)
                .compact();
    }
