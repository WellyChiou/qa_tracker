...
public class User {
    ...
    private Set<com.example.helloworld.entity.personal.Role> roles = new HashSet<>();
    ...
    private Set<com.example.helloworld.entity.personal.Permission> permissions = new HashSet<>(); // 用戶直接分配的權限
    ...
    public Set<com.example.helloworld.entity.personal.Role> getRoles() { return roles; }
    public void setRoles(Set<com.example.helloworld.entity.personal.Role> roles) { this.roles = roles; }

    public Set<com.example.helloworld.entity.personal.Permission> getPermissions() { return permissions; }
    public void setPermissions(Set<com.example.helloworld.entity.personal.Permission> permissions) { this.permissions = permissions; }
}
