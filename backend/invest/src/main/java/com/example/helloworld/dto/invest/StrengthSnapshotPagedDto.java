...
public class StrengthSnapshotPagedDto {
    private Long id;
    ...
    private List<StrengthFactorDto> topFactors;
    ...
    public List<StrengthFactorDto> getTopFactors() {
        return topFactors;
    }

    public void setTopFactors(List<StrengthFactorDto> topFactors) {
