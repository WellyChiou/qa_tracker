...
public class PermissionService {
     ...
     */
    @Transactional(readOnly = true)
    public Page<Permission> getAllPermissions(String permissionCode, String resource, String action, int page, int size) {
        ...
        return permissionRepository.findByFilters(filterPermissionCode, filterResource, filterAction, pageable);
    }
