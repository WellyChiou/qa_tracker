...
usage() {
  cat <<'EOF'
用法：
  ./scripts/migration/run-church-migrations.sh [options]
...
# 注意：只納入已驗證可重複執行且屬 baseline 的 church SQL（不含 demo data）
run_one "C001" "database/church/schema/church-schema.sql"
run_one "C002" "database/church/schema/church-init.sql"
run_one "C003" "database/church/schema/church-security-tables.sql"
run_one "C004" "database/church/schema/system-settings-schema.sql"
run_one "C005" "database/church/schema/church-scheduled-jobs-schema.sql"
run_one "C006" "database/church/setup/church-admin-setup.sql"
run_one "C007" "database/church/setup/patch_fix_backup_download_url_permission.sql"

echo "=========================================="
echo "✅ Church migrations 完成"
echo "=========================================="
